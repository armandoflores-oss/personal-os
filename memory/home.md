...
_Todo lo que el sistema sabe de ti, a un clic o dos de aquí. Esta página la mantiene Claude; si algo está mal, dilo en una sesión y se corrige en la fuente, no aquí._

## Tus dominios

Los seis por los que el brief ordena tus pendientes, en el orden en que los lees.

| Dominio | De qué va |
|---|---|
| [[cotizaciones-operativo\|Cotizaciones y pendientes operativos]] | Cotizaciones, seguimientos, el día a día que sí te toca |
| [[operacion-kavak\|Operación Kavak]] | La cuenta Kavak |
| [[reuniones-espana\|Reuniones España]] | Acuerdos de las juntas de España, incluido Clicars |
| [[grandes-deals\|Grandes deals / RFPs]] | Uber AV, BCA, Penske |
| [[pipeline-estrategico\|Pipeline estratégico]] | Ford, Tesla, Element: automatización y proceso |
| [[operacion-semanal\|Operación semanal y márgenes]] | Semanales, equipo, márgenes, juntas de comunicación |

Dos dominios más existen y **no se mapean aquí a propósito**: finanzas personales y familia. El código los sella; nunca se auto-procesan ni se cruzan con nada.
...
[[fede-ranero|Fede Ranero]] · [[nico-ariza|Nico Ariza]] · [[dan-rizzo|Dan Rizzo]] · [[jose-duran|José Durán]] · [[marcelo-trevino|Marcelo Treviño]] · [[uriel-vargas|Uriel Vargas]] · [[artur-morais|Artur Morais]] · [[paloma-calderon|Paloma Calderón]] · [[carolina-osses|Carolina Osses]] · [[daniel-escribano|Daniel Escribano]] · [[juliana-turbofin|Juliana · Turbofin]]
...
Cómo funciona lo que produce todo esto. Vive **fuera del vault**, en el repo, así que estos abren en tu editor o en Finder, no dentro de Obsidian.

- [Estado del build — qué fase va y qué falta](file:///Users/armando/Documents/Claude%20Personal%20Improvement/replication-state.md)
- [Configuración: dominios, firewall, horarios](file:///Users/armando/Documents/Claude%20Personal%20Improvement/config/os-config.md)
- [El spec completo](file:///Users/armando/Documents/Claude%20Personal%20Improvement/self-improving-os-bootstrap.md)
- [Instrucción de captura siempre activa](file:///Users/armando/Documents/Claude%20Personal%20Improvement/docs/instruccion-captura.md)
- [Rutina de ingesta](file:///Users/armando/Documents/Claude%20Personal%20Improvement/docs/rutina-ingesta.md) · [Rutina del brief](file:///Users/armando/Documents/Claude%20Personal%20Improvement/docs/rutina-brief.md)
...
- [[glossary|Glosario]] — términos de Draiver y del sistema

---

**Cómo responder.** Cualquier renglón con código lo puedes contestar en cuatro palabras: `T-4 listo` · `T-9 viernes` · `T-23 qué` · `T-31 es de Uriel`.
